...
describe("permissionServices service", async () => {
  ...
  const companiesCreated = await app
    .service("companies")
    .Model.create({
      service: "new value",
      create: true,
  ...
  const departmentsCreated = await app
    .service("departments")
    .Model.create({
      service: "new value",
      create: true,
  ...
  const sectionsCreated = await app
    .service("sections")
    .Model.create({
      service: "new value",
      create: true,
  ...
  const positionsCreated = await app
    .service("positions")
    .Model.create({
      service: "new value",
      create: true,
  ...
  const branchesCreated = await app
    .service("branches")
    .Model.create({
      service: "new value",
      create: true,
  ...
  const userPhonesCreated = await app
    .service("userPhones")
    .Model.create({
      service: "new value",
      create: true,
  ...
  const profilesCreated = await app
    .service("profiles")
    .Model.create({
      service: "new value",
      create: true,
  ...
  describe("#delete", async () => {
    it("should delete a permissionService", async () => {
      ...
      const permissionServiceDeleted =
        await thisService.Model.findByIdAndDelete(permissionServiceCreated._id);
      assert.strictEqual(
