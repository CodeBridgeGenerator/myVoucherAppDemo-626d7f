...
phoneNo: _entity?.phoneNo,
    ...
    return (
        <Dialog header="Edit User Details" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="userDetails-edit-dialog-component">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="phoneNo" className="w-full mb-3 p-inputtext-sm" value={_entity?.phoneNo} onChange={(e) => setValByKey("phoneNo", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
